...
#include "Debug.h"
template <typename T> class CAT : public GPUSolver<T>
{
  protected:
  ...
  public:
    CAT(int deviceId, CADataDomain<T> *deviceData, CADataDomain<T> *deviceDataBuffer)
...
#include "CellularAutomata/Solvers/CAT.tpp"