...
template <typename T> class COARSE : public GPUSolver<T>
{
  private:
  ...
  public:
    COARSE(int deviceId, CADataDomain<T> *deviceData, CADataDomain<T> *deviceDataBuffer)
...
#include "CellularAutomata/Solvers/COARSE.tpp"