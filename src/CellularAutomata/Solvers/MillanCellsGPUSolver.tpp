...
void MillanCellsGPUSolver<T>::setupGridSize() {
    ...
    this->GPUGrid = dim3(ceil((float)n / (float)(this->GPUBlock.x - 2 * this->dataDomainDevice->getHorizontalHaloSize())), ceil((float)n / (float)(this->GPUBlock.y - 2 * this->dataDomainDevice->getHorizontalHaloSize())));
