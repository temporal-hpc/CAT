...
template <typename T> void CAT<T>::setupSharedMemoryCarveout()
{
...
template <typename T> void CAT<T>::createStream()
{
    cudaStreamCreate(&mainStream);
}

template <typename T> void CAT<T>::moveCurrentDeviceStateToGPUBuffer()
{
...
template <typename T> void CAT<T>::moveGPUBufferToCurrentDeviceState()
{
...
template <typename T> void CAT<T>::fillHorizontalBoundaryConditions()
{
    int n = this->dataDomainDevice->getInnerHorizontalSize();
...
template <typename T> void CAT<T>::fillVerticalBoundaryConditions()
{
    int n = this->dataDomainDevice->getInnerHorizontalSize();
...
template <typename T> void CAT<T>::CAStepAlgorithm()
{
    int n = this->dataDomainDevice->getInnerHorizontalSize();
    CAT_KERNEL<<<this->GPUGrid, this->GPUBlock, sharedMemoryBytes, mainStream>>>(
