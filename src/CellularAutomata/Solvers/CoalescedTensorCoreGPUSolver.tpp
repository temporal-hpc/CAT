...
void CoalescedTensorCoreGPUSolver<T>::CAStepAlgorithm() {
    int n = this->dataDomainDevice->getInnerHorizontalSize();
    TensorCoalescedV1GoLStep<<<this->GPUGrid, this->GPUBlock, sharedMemoryBytes, mainStream>>>(this->dataDomainDevice->getData(), this->dataDomainBufferDevice->getData(), n, this->dataDomainDevice->getFullHorizontalSize());
