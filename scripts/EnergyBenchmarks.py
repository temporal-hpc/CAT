...
smin = [2, 7,  15, 40, 35, 49, 101,  163, 108, 122, 156, 170, 213, 245, 170]
smax = [3, 12, 23, 80, 59, 81, 201,  223, 181, 211, 265, 296, 364, 420, 296]
bmin = [3, 8,  14, 41, 34, 46, 75,   74,  100, 123, 147, 170, 203, 234, 170]
bmax = [3, 11, 17, 80, 45, 65, 170,  252, 140, 170, 205, 240, 283, 326, 240]   
densities = [0.07, 0.15, 0.25, 0.50, 0.21, 0.22, 0.29, 0.23, 0.24, 0.25, 0.24, 0.25, 0.25, 0.25, 0.28]
# 1: passed
# 0: failed
results = {}
auxdict = {} 
